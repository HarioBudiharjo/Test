...
@class SharedSurvey, SharedEnvironmentType, SharedKtor_client_coreHttpResponse, SharedLoanHistory, SharedGenericResponse<T>, SharedResultData<__covariant T>, SharedGenericResponseCompanion, SharedKotlinArray<T>, SharedHolidayLoanCompanion, SharedHolidayLoan, SharedInstallmentCompanion, SharedInstallment, SharedLoanCompanion, SharedLoan, SharedLoanHistoryCompanion, SharedSurveyCompanion, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpClient, SharedBaseHttpRequest, SharedNetworkClient, SharedEnvironmentTypeDev, SharedEnvironmentTypeLive, SharedEnvironmentTypeStaging, SharedResultDataCompanion, SharedKotlinThrowable, SharedResultDataFailure<__covariant T>, SharedResultDataLoading<__covariant T>, SharedResultDataSuccess<__covariant T>, SharedBuildConfig, SharedKodein_diDIModule, SharedKtor_client_coreHttpClientCall, SharedKtor_utilsGMTDate, SharedKtor_httpHttpStatusCode, SharedKtor_httpHttpProtocolVersion, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_client_coreHttpRequestData, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_httpHttpMethod, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreHttpClientCallCompanion, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKotlinByteArray, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_httpHttpProtocolVersionCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpUrl, SharedKtor_httpOutgoingContent, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpURLProtocol, SharedKtor_httpURLBuilderCompanion, SharedKotlinCancellationException, SharedKtor_httpHttpMethodCompanion, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKtor_client_coreProxyConfig, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKotlinUnit, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpSendPipelinePhases, SharedKodein_diDIBuilderDelegateBinder<T>, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_httpUrlCompanion, SharedKtor_httpContentType, SharedKtor_httpURLProtocolCompanion, SharedKotlinKTypeProjection, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKodein_diDIKey<__contravariant C, __contravariant A, __covariant T>, SharedKodein_diScopeRegistry, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKodein_diDITrigger, SharedKodein_diReference<__covariant T>, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKodein_diDIDefinition<C, A, T>, SharedKotlinTriple<__covariant A, __covariant B, __covariant C>, SharedKodein_diSearchSpecs, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>, SharedKodein_diDIDefining<C, A, T>;

@protocol SharedLoanHistoryUseCase, SharedLoanHistoryInstance, SharedFeedbackUseCase, SharedResultDataInterface, SharedTnkNetworkRepository, SharedInternalNetworkRepository, SharedTnkNetworkService, SharedKotlinx_serialization_coreKSerializer, SharedInternalNetworkService, SharedKtor_httpHeaders, SharedKtor_httpHttpMessage, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreCoroutineScope, SharedKtor_ioByteReadChannel, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_utilsAttributes, SharedKotlinx_coroutines_coreJob, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngine, SharedKodein_diDIBuilder, SharedKotlinKProperty, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKtor_client_coreHttpRequest, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKotlinComparable, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParameters, SharedKtor_httpParametersBuilder, SharedKotlinKClass, SharedKotlinKType, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKtor_client_coreHttpClientPlugin, SharedKotlinSuspendFunction2, SharedKodein_diDIBuilderDirectBinder, SharedKodein_diDIBinding, SharedKodein_diDIBuilderTypeBinder, SharedKodein_typeTypeToken, SharedKodein_diContextTranslator, SharedKodein_diDIBuilderConstantBinder, SharedKodein_diDirectDI, SharedKodein_diDIContainerBuilder, SharedKodein_diDIBindBuilder, SharedKodein_diScope, SharedKodein_diDIBindBuilderWithScope, SharedKotlinKAnnotatedElement, SharedKotlinKCallable, SharedKtor_ioObjectPool, SharedKotlinFunction, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKDeclarationContainer, SharedKotlinKClassifier, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKodein_diDIBindingCopier, SharedKodein_diBindingDI, SharedKodein_diBinding, SharedKodein_diDIContext, SharedKodein_diDIContainer, SharedKodein_diDI, SharedKodein_diDirectDIAware, SharedKodein_diDirectDIBase, SharedKodein_diWithContext, SharedKodein_diDITree, SharedKodein_diDIAware, SharedKodein_diScopeCloseable, SharedKodein_diExternalSource, SharedKotlinLazy;
...
__attribute__((swift_name("LoanHistoryInstance")))
@protocol SharedLoanHistoryInstance
@required
- (id<SharedLoanHistoryUseCase>)loanHistoryUseCaseInstance __attribute__((swift_name("loanHistoryUseCaseInstance()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoanHistoryInstanceImpl")))
@interface SharedLoanHistoryInstanceImpl : SharedBase <SharedLoanHistoryInstance>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<SharedLoanHistoryUseCase>)loanHistoryUseCaseInstance __attribute__((swift_name("loanHistoryUseCaseInstance()")));
@end

__attribute__((swift_name("FeedbackUseCase")))
@protocol SharedFeedbackUseCase
@required
- (void)sendFeedbackBodyRequest:(SharedSurvey * _Nullable)bodyRequest environmentType:(SharedEnvironmentType *)environmentType callback:(id)callback __attribute__((swift_name("sendFeedback(bodyRequest:environmentType:callback:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeedbackUseCaseImpl")))
@interface SharedFeedbackUseCaseImpl : SharedBase <SharedFeedbackUseCase>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)sendFeedbackBodyRequest:(SharedSurvey * _Nullable)bodyRequest environmentType:(SharedEnvironmentType *)environmentType callback:(id)callback __attribute__((swift_name("sendFeedback(bodyRequest:environmentType:callback:)")));
@end

__attribute__((swift_name("LoanHistoryUseCase")))
@protocol SharedLoanHistoryUseCase
@required
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType callback:(id<SharedResultDataInterface>)callback __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:callback:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoanHistoryUseCaseImpl")))
@interface SharedLoanHistoryUseCaseImpl : SharedBase <SharedLoanHistoryUseCase>
- (instancetype)initWithTnkNetworkRepository:(id<SharedTnkNetworkRepository>)tnkNetworkRepository __attribute__((swift_name("init(tnkNetworkRepository:)"))) __attribute__((objc_designated_initializer));
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType callback:(id<SharedResultDataInterface>)callback __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:callback:)")));
@end

__attribute__((swift_name("InternalNetworkRepository")))
@protocol SharedInternalNetworkRepository
@required
- (void)sendFeedbackBodyRequest:(SharedSurvey * _Nullable)bodyRequest environmentType:(SharedEnvironmentType *)environmentType func:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable))func __attribute__((swift_name("sendFeedback(bodyRequest:environmentType:func:)")));
@end

__attribute__((swift_name("TnkNetworkRepository")))
@protocol SharedTnkNetworkRepository
@required
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType func:(void (^)(SharedResultData<SharedGenericResponse<SharedLoanHistory *> *> *))func __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:func:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InternalNetworkRepositoryImpl")))
@interface SharedInternalNetworkRepositoryImpl : SharedBase <SharedInternalNetworkRepository>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)sendFeedbackBodyRequest:(SharedSurvey * _Nullable)bodyRequest environmentType:(SharedEnvironmentType *)environmentType func:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable))func __attribute__((swift_name("sendFeedback(bodyRequest:environmentType:func:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TnkNetworkRepositoryImpl")))
@interface SharedTnkNetworkRepositoryImpl : SharedBase <SharedTnkNetworkRepository>
- (instancetype)initWithTnkNetworkService:(id<SharedTnkNetworkService>)tnkNetworkService __attribute__((swift_name("init(tnkNetworkService:)"))) __attribute__((objc_designated_initializer));
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType func:(void (^)(SharedResultData<SharedGenericResponse<SharedLoanHistory *> *> *))func __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:func:)")));
@end
...
@interface SharedGenericResponse<T> : SharedBase
- (instancetype)initWithMessage:(NSString * _Nullable)message time:(NSString * _Nullable)time result:(T _Nullable)result code:(SharedInt * _Nullable)code __attribute__((swift_name("init(message:time:result:code:)"))) __attribute__((objc_designated_initializer));
...
- (SharedInt * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedGenericResponse<T> *)doCopyMessage:(NSString * _Nullable)message time:(NSString * _Nullable)time result:(T _Nullable)result code:(SharedInt * _Nullable)code __attribute__((swift_name("doCopy(message:time:result:code:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GenericResponseCompanion")))
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HolidayLoan")))
@interface SharedHolidayLoan : SharedBase
- (instancetype)initWithOfferingStatus:(int32_t)offeringStatus isActive:(BOOL)isActive __attribute__((swift_name("init(offeringStatus:isActive:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedHolidayLoanCompanion *companion __attribute__((swift_name("companion")));
...
- (SharedHolidayLoan *)doCopyOfferingStatus:(int32_t)offeringStatus isActive:(BOOL)isActive __attribute__((swift_name("doCopy(offeringStatus:isActive:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property BOOL isActive __attribute__((swift_name("isActive")));
@property int32_t offeringStatus __attribute__((swift_name("offeringStatus")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HolidayLoan.Companion")))
@interface SharedHolidayLoanCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedHolidayLoanCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Installment")))
@interface SharedInstallment : SharedBase
- (instancetype)initWithDate:(NSString * _Nullable)date sum:(NSString * _Nullable)sum partNum:(NSString * _Nullable)partNum unpaid:(NSString * _Nullable)unpaid rowType:(NSString * _Nullable)rowType onTime:(SharedBoolean * _Nullable)onTime mlpPoint:(int32_t)mlpPoint status:(NSString * _Nullable)status __attribute__((swift_name("init(date:sum:partNum:unpaid:rowType:onTime:mlpPoint:status:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedInstallmentCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedBoolean * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedInstallment *)doCopyDate:(NSString * _Nullable)date sum:(NSString * _Nullable)sum partNum:(NSString * _Nullable)partNum unpaid:(NSString * _Nullable)unpaid rowType:(NSString * _Nullable)rowType onTime:(SharedBoolean * _Nullable)onTime mlpPoint:(int32_t)mlpPoint status:(NSString * _Nullable)status __attribute__((swift_name("doCopy(date:sum:partNum:unpaid:rowType:onTime:mlpPoint:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable date __attribute__((swift_name("date")));
@property int32_t mlpPoint __attribute__((swift_name("mlpPoint")));
@property SharedBoolean * _Nullable onTime __attribute__((swift_name("onTime")));
@property NSString * _Nullable partNum __attribute__((swift_name("partNum")));
@property NSString * _Nullable rowType __attribute__((swift_name("rowType")));
@property NSString * _Nullable status __attribute__((swift_name("status")));
@property NSString * _Nullable sum __attribute__((swift_name("sum")));
@property NSString * _Nullable unpaid __attribute__((swift_name("unpaid")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Installment.Companion")))
@interface SharedInstallmentCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedInstallmentCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedLoan : SharedBase
- (instancetype)initWithId:(SharedInt * _Nullable)id status:(NSString * _Nullable)status amount:(NSString * _Nullable)amount period:(NSString * _Nullable)period saldo:(NSString * _Nullable)saldo partnerType:(NSString * _Nullable)partnerType paidOutDate:(NSString * _Nullable)paidOutDate totalUnpaid:(NSString * _Nullable)totalUnpaid installments:(NSArray<SharedInstallment *> * _Nullable)installments contractStatus:(NSString * _Nullable)contractStatus earlyPayment:(NSString * _Nullable)earlyPayment prePaymentSaldo:(NSString * _Nullable)prePaymentSaldo productType:(NSString * _Nullable)productType unpaidMonths:(NSString * _Nullable)unpaidMonths applicationStatus:(NSString * _Nullable)applicationStatus contractSentDate:(NSString * _Nullable)contractSentDate mlpScore:(SharedInt * _Nullable)mlpScore isEligibleSurvey:(SharedBoolean * _Nullable)isEligibleSurvey holidayLoan:(SharedHolidayLoan * _Nullable)holidayLoan isEligibleForLoanPatch:(SharedBoolean * _Nullable)isEligibleForLoanPatch loanProcessingFeeAmount:(NSString * _Nullable)loanProcessingFeeAmount toBankAmount:(NSString * _Nullable)toBankAmount loanProcessingFeePercentage:(NSString * _Nullable)loanProcessingFeePercentage earlyPaymentForTopUp:(NSString * _Nullable)earlyPaymentForTopUp firstInstallmentValue:(NSString * _Nullable)firstInstallmentValue submitType:(NSString * _Nullable)submitType digitalSigningProgress:(NSString * _Nullable)digitalSigningProgress currentInstallmentValue:(NSString * _Nullable)currentInstallmentValue rejectReason:(NSString * _Nullable)rejectReason mediaSource:(SharedInt * _Nullable)mediaSource __attribute__((swift_name("init(id:status:amount:period:saldo:partnerType:paidOutDate:totalUnpaid:installments:contractStatus:earlyPayment:prePaymentSaldo:productType:unpaidMonths:applicationStatus:contractSentDate:mlpScore:isEligibleSurvey:holidayLoan:isEligibleForLoanPatch:loanProcessingFeeAmount:toBankAmount:loanProcessingFeePercentage:earlyPaymentForTopUp:firstInstallmentValue:submitType:digitalSigningProgress:currentInstallmentValue:rejectReason:mediaSource:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLoanCompanion *companion __attribute__((swift_name("companion")));
- (SharedInt * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedInt * _Nullable)component17 __attribute__((swift_name("component17()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedBoolean * _Nullable)component18 __attribute__((swift_name("component18()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedHolidayLoan * _Nullable)component19 __attribute__((swift_name("component19()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedBoolean * _Nullable)component20 __attribute__((swift_name("component20()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSString * _Nullable)component28 __attribute__((swift_name("component28()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component29 __attribute__((swift_name("component29()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component30 __attribute__((swift_name("component30()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSString * _Nullable)component8 __attribute__((swift_name("component8()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<SharedInstallment *> * _Nullable)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLoan *)doCopyId:(SharedInt * _Nullable)id status:(NSString * _Nullable)status amount:(NSString * _Nullable)amount period:(NSString * _Nullable)period saldo:(NSString * _Nullable)saldo partnerType:(NSString * _Nullable)partnerType paidOutDate:(NSString * _Nullable)paidOutDate totalUnpaid:(NSString * _Nullable)totalUnpaid installments:(NSArray<SharedInstallment *> * _Nullable)installments contractStatus:(NSString * _Nullable)contractStatus earlyPayment:(NSString * _Nullable)earlyPayment prePaymentSaldo:(NSString * _Nullable)prePaymentSaldo productType:(NSString * _Nullable)productType unpaidMonths:(NSString * _Nullable)unpaidMonths applicationStatus:(NSString * _Nullable)applicationStatus contractSentDate:(NSString * _Nullable)contractSentDate mlpScore:(SharedInt * _Nullable)mlpScore isEligibleSurvey:(SharedBoolean * _Nullable)isEligibleSurvey holidayLoan:(SharedHolidayLoan * _Nullable)holidayLoan isEligibleForLoanPatch:(SharedBoolean * _Nullable)isEligibleForLoanPatch loanProcessingFeeAmount:(NSString * _Nullable)loanProcessingFeeAmount toBankAmount:(NSString * _Nullable)toBankAmount loanProcessingFeePercentage:(NSString * _Nullable)loanProcessingFeePercentage earlyPaymentForTopUp:(NSString * _Nullable)earlyPaymentForTopUp firstInstallmentValue:(NSString * _Nullable)firstInstallmentValue submitType:(NSString * _Nullable)submitType digitalSigningProgress:(NSString * _Nullable)digitalSigningProgress currentInstallmentValue:(NSString * _Nullable)currentInstallmentValue rejectReason:(NSString * _Nullable)rejectReason mediaSource:(SharedInt * _Nullable)mediaSource __attribute__((swift_name("doCopy(id:status:amount:period:saldo:partnerType:paidOutDate:totalUnpaid:installments:contractStatus:earlyPayment:prePaymentSaldo:productType:unpaidMonths:applicationStatus:contractSentDate:mlpScore:isEligibleSurvey:holidayLoan:isEligibleForLoanPatch:loanProcessingFeeAmount:toBankAmount:loanProcessingFeePercentage:earlyPaymentForTopUp:firstInstallmentValue:submitType:digitalSigningProgress:currentInstallmentValue:rejectReason:mediaSource:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable amount __attribute__((swift_name("amount")));
@property NSString * _Nullable applicationStatus __attribute__((swift_name("applicationStatus")));
@property NSString * _Nullable contractSentDate __attribute__((swift_name("contractSentDate")));
@property NSString * _Nullable contractStatus __attribute__((swift_name("contractStatus")));
@property NSString * _Nullable currentInstallmentValue __attribute__((swift_name("currentInstallmentValue")));
@property NSString * _Nullable digitalSigningProgress __attribute__((swift_name("digitalSigningProgress")));
@property NSString * _Nullable earlyPayment __attribute__((swift_name("earlyPayment")));
@property NSString * _Nullable earlyPaymentForTopUp __attribute__((swift_name("earlyPaymentForTopUp")));
@property NSString * _Nullable firstInstallmentValue __attribute__((swift_name("firstInstallmentValue")));
@property SharedHolidayLoan * _Nullable holidayLoan __attribute__((swift_name("holidayLoan")));
@property SharedInt * _Nullable id __attribute__((swift_name("id")));
@property NSArray<SharedInstallment *> * _Nullable installments __attribute__((swift_name("installments")));
@property SharedBoolean * _Nullable isEligibleForLoanPatch __attribute__((swift_name("isEligibleForLoanPatch")));
@property SharedBoolean * _Nullable isEligibleSurvey __attribute__((swift_name("isEligibleSurvey")));
@property NSString * _Nullable loanProcessingFeeAmount __attribute__((swift_name("loanProcessingFeeAmount")));
@property NSString * _Nullable loanProcessingFeePercentage __attribute__((swift_name("loanProcessingFeePercentage")));
@property SharedInt * _Nullable mediaSource __attribute__((swift_name("mediaSource")));
@property SharedInt * _Nullable mlpScore __attribute__((swift_name("mlpScore")));
@property NSString * _Nullable paidOutDate __attribute__((swift_name("paidOutDate")));
@property NSString * _Nullable partnerType __attribute__((swift_name("partnerType")));
@property NSString * _Nullable period __attribute__((swift_name("period")));
@property NSString * _Nullable prePaymentSaldo __attribute__((swift_name("prePaymentSaldo")));
@property NSString * _Nullable productType __attribute__((swift_name("productType")));
@property NSString * _Nullable rejectReason __attribute__((swift_name("rejectReason")));
@property NSString * _Nullable saldo __attribute__((swift_name("saldo")));
@property NSString * _Nullable status __attribute__((swift_name("status")));
@property NSString * _Nullable submitType __attribute__((swift_name("submitType")));
@property NSString * _Nullable toBankAmount __attribute__((swift_name("toBankAmount")));
@property NSString * _Nullable totalUnpaid __attribute__((swift_name("totalUnpaid")));
@property NSString * _Nullable unpaidMonths __attribute__((swift_name("unpaidMonths")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Loan.Companion")))
@interface SharedLoanCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLoanCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoanHistory")))
@interface SharedLoanHistory : SharedBase
- (instancetype)initWithPage:(SharedInt * _Nullable)page pageCount:(SharedInt * _Nullable)pageCount limit:(SharedInt * _Nullable)limit totalData:(SharedInt * _Nullable)totalData data:(NSArray<SharedLoan *> * _Nullable)data __attribute__((swift_name("init(page:pageCount:limit:totalData:data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLoanHistoryCompanion *companion __attribute__((swift_name("companion")));
- (SharedInt * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedInt * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<SharedLoan *> * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedLoanHistory *)doCopyPage:(SharedInt * _Nullable)page pageCount:(SharedInt * _Nullable)pageCount limit:(SharedInt * _Nullable)limit totalData:(SharedInt * _Nullable)totalData data:(NSArray<SharedLoan *> * _Nullable)data __attribute__((swift_name("doCopy(page:pageCount:limit:totalData:data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSArray<SharedLoan *> * _Nullable data __attribute__((swift_name("data")));
@property SharedInt * _Nullable limit __attribute__((swift_name("limit")));
@property SharedInt * _Nullable page __attribute__((swift_name("page")));
@property SharedInt * _Nullable pageCount __attribute__((swift_name("pageCount")));
@property SharedInt * _Nullable totalData __attribute__((swift_name("totalData")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoanHistory.Companion")))
@interface SharedLoanHistoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLoanHistoryCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Survey")))
@interface SharedSurvey : SharedBase
- (instancetype)initWithTopBarId:(SharedInt * _Nullable)topBarId description:(NSString * _Nullable)description cesId:(SharedInt * _Nullable)cesId emoScoreId:(SharedInt * _Nullable)emoScoreId journeyPoint:(NSString * _Nullable)journeyPoint submittedAt:(NSString * _Nullable)submittedAt versionCode:(NSString * _Nullable)versionCode versionName:(NSString * _Nullable)versionName media:(NSString * _Nullable)media name:(NSString * _Nullable)name email:(NSString * _Nullable)email dob:(NSString * _Nullable)dob phone:(NSString * _Nullable)phone applicationStatus:(NSString * _Nullable)applicationStatus citizenId:(NSString * _Nullable)citizenId educationType:(NSString * _Nullable)educationType gender:(NSString * _Nullable)gender loanPurposeType:(NSString * _Nullable)loanPurposeType incomeJobType:(NSString * _Nullable)incomeJobType incomeEmploymentStatus:(NSString * _Nullable)incomeEmploymentStatus incomeWorkPosition:(NSString * _Nullable)incomeWorkPosition deviceName:(NSString * _Nullable)deviceName osVersion:(NSString * _Nullable)osVersion freeMemory:(NSString * _Nullable)freeMemory mediaSource:(NSString * _Nullable)mediaSource productType:(NSString * _Nullable)productType mlpLevel:(NSString * _Nullable)mlpLevel loanId:(NSString * _Nullable)loanId __attribute__((swift_name("init(topBarId:description:cesId:emoScoreId:journeyPoint:submittedAt:versionCode:versionName:media:name:email:dob:phone:applicationStatus:citizenId:educationType:gender:loanPurposeType:incomeJobType:incomeEmploymentStatus:incomeWorkPosition:deviceName:osVersion:freeMemory:mediaSource:productType:mlpLevel:loanId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSurveyCompanion *companion __attribute__((swift_name("companion")));
- (SharedInt * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component11 __attribute__((swift_name("component11()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component12 __attribute__((swift_name("component12()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedSurvey *)doCopyTopBarId:(SharedInt * _Nullable)topBarId description:(NSString * _Nullable)description cesId:(SharedInt * _Nullable)cesId emoScoreId:(SharedInt * _Nullable)emoScoreId journeyPoint:(NSString * _Nullable)journeyPoint submittedAt:(NSString * _Nullable)submittedAt versionCode:(NSString * _Nullable)versionCode versionName:(NSString * _Nullable)versionName media:(NSString * _Nullable)media name:(NSString * _Nullable)name email:(NSString * _Nullable)email dob:(NSString * _Nullable)dob phone:(NSString * _Nullable)phone applicationStatus:(NSString * _Nullable)applicationStatus citizenId:(NSString * _Nullable)citizenId educationType:(NSString * _Nullable)educationType gender:(NSString * _Nullable)gender loanPurposeType:(NSString * _Nullable)loanPurposeType incomeJobType:(NSString * _Nullable)incomeJobType incomeEmploymentStatus:(NSString * _Nullable)incomeEmploymentStatus incomeWorkPosition:(NSString * _Nullable)incomeWorkPosition deviceName:(NSString * _Nullable)deviceName osVersion:(NSString * _Nullable)osVersion freeMemory:(NSString * _Nullable)freeMemory mediaSource:(NSString * _Nullable)mediaSource productType:(NSString * _Nullable)productType mlpLevel:(NSString * _Nullable)mlpLevel loanId:(NSString * _Nullable)loanId __attribute__((swift_name("doCopy(topBarId:description:cesId:emoScoreId:journeyPoint:submittedAt:versionCode:versionName:media:name:email:dob:phone:applicationStatus:citizenId:educationType:gender:loanPurposeType:incomeJobType:incomeEmploymentStatus:incomeWorkPosition:deviceName:osVersion:freeMemory:mediaSource:productType:mlpLevel:loanId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable applicationStatus __attribute__((swift_name("applicationStatus")));
@property (readonly) SharedInt * _Nullable cesId __attribute__((swift_name("cesId")));
@property (readonly) NSString * _Nullable citizenId __attribute__((swift_name("citizenId")));
...
@property (readonly) NSString * _Nullable educationType __attribute__((swift_name("educationType")));
@property (readonly) NSString * _Nullable email __attribute__((swift_name("email")));
@property (readonly) SharedInt * _Nullable emoScoreId __attribute__((swift_name("emoScoreId")));
@property (readonly) NSString * _Nullable freeMemory __attribute__((swift_name("freeMemory")));
@property (readonly) NSString * _Nullable gender __attribute__((swift_name("gender")));
@property (readonly) NSString * _Nullable incomeEmploymentStatus __attribute__((swift_name("incomeEmploymentStatus")));
@property (readonly) NSString * _Nullable incomeJobType __attribute__((swift_name("incomeJobType")));
@property (readonly) NSString * _Nullable incomeWorkPosition __attribute__((swift_name("incomeWorkPosition")));
@property (readonly) NSString * _Nullable journeyPoint __attribute__((swift_name("journeyPoint")));
@property (readonly) NSString * _Nullable loanId __attribute__((swift_name("loanId")));
@property (readonly) NSString * _Nullable loanPurposeType __attribute__((swift_name("loanPurposeType")));
@property (readonly) NSString * _Nullable media __attribute__((swift_name("media")));
@property (readonly) NSString * _Nullable mediaSource __attribute__((swift_name("mediaSource")));
@property (readonly) NSString * _Nullable mlpLevel __attribute__((swift_name("mlpLevel")));
...
@property (readonly) NSString * _Nullable productType __attribute__((swift_name("productType")));
@property (readonly) NSString * _Nullable submittedAt __attribute__((swift_name("submittedAt")));
@property (readonly) SharedInt * _Nullable topBarId __attribute__((swift_name("topBarId")));
@property (readonly) NSString * _Nullable versionCode __attribute__((swift_name("versionCode")));
@property (readonly) NSString * _Nullable versionName __attribute__((swift_name("versionName")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Survey.Companion")))
@interface SharedSurveyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSurveyCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("BaseHttpRequest")))
@interface SharedBaseHttpRequest : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
...
*/
- (void)createRequestRequestBuilder:(SharedKtor_client_coreHttpRequestBuilder *)requestBuilder completionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("createRequest(requestBuilder:completionHandler:)")));
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end

__attribute__((swift_name("TnkNetworkService")))
@protocol SharedTnkNetworkService
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType completionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TnkNetworkServiceImpl")))
@interface SharedTnkNetworkServiceImpl : SharedBaseHttpRequest <SharedTnkNetworkService>
- (instancetype)initWithNetworkClient:(SharedNetworkClient *)networkClient __attribute__((swift_name("init(networkClient:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLoanHistoryAccessToken:(NSString *)accessToken page:(int32_t)page environmentType:(SharedEnvironmentType *)environmentType completionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLoanHistory(accessToken:page:environmentType:completionHandler:)")));
@end

__attribute__((swift_name("InternalNetworkService")))
@protocol SharedInternalNetworkService
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)sendFeedbackBodyRequest:(SharedSurvey * _Nullable)bodyRequest environmentType:(SharedEnvironmentType *)environmentType completionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("sendFeedback(bodyRequest:environmentType:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InternalNetworkServiceImpl")))
@interface SharedInternalNetworkServiceImpl : SharedBaseHttpRequest <SharedInternalNetworkService>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@interface SharedEnvironmentType : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EnvironmentType.Dev")))
@interface SharedEnvironmentTypeDev : SharedEnvironmentType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)dev __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEnvironmentTypeDev *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EnvironmentType.Live")))
@interface SharedEnvironmentTypeLive : SharedEnvironmentType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)live __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEnvironmentTypeLive *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("EnvironmentType.Staging")))
@interface SharedEnvironmentTypeStaging : SharedEnvironmentType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)staging __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedEnvironmentTypeStaging *shared __attribute__((swift_name("shared")));
@end

__attribute__((swift_name("Result")))
@protocol SharedResult
@required
- (void)httpStatusCode:(int32_t)code __attribute__((swift_name("httpStatus(code:)")));
@end

__attribute__((swift_name("ResultData")))
@interface SharedResultData<__covariant T> : SharedBase
@property (class, readonly, getter=companion) SharedResultDataCompanion *companion __attribute__((swift_name("companion")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultDataCompanion")))
@interface SharedResultDataCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedResultDataCompanion *shared __attribute__((swift_name("shared")));
- (SharedResultData<id> *)failureMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("failure(message:throwable:)")));
- (SharedResultData<id> *)loadingValue:(id _Nullable)value __attribute__((swift_name("loading(value:)")));
- (SharedResultData<id> *)successValue:(id _Nullable)value code:(SharedInt * _Nullable)code __attribute__((swift_name("success(value:code:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultDataFailure")))
@interface SharedResultDataFailure<__covariant T> : SharedResultData<T>
- (instancetype)initWithMessage:(NSString *)message data:(SharedKotlinThrowable *)data __attribute__((swift_name("init(message:data:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedKotlinThrowable *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedResultDataFailure<T> *)doCopyMessage:(NSString *)message data:(SharedKotlinThrowable *)data __attribute__((swift_name("doCopy(message:data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedKotlinThrowable *data __attribute__((swift_name("data")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultDataLoading")))
@interface SharedResultDataLoading<__covariant T> : SharedResultData<T>
...
- (SharedResultDataLoading<T> *)doCopyValue:(T _Nullable)value __attribute__((swift_name("doCopy(value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultDataSuccess")))
@interface SharedResultDataSuccess<__covariant T> : SharedResultData<T>
- (instancetype)initWithValue:(T _Nullable)value code:(SharedInt * _Nullable)code __attribute__((swift_name("init(value:code:)"))) __attribute__((objc_designated_initializer));
- (T _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedInt * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedResultDataSuccess<T> *)doCopyValue:(T _Nullable)value code:(SharedInt * _Nullable)code __attribute__((swift_name("doCopy(value:code:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedInt * _Nullable code __attribute__((swift_name("code")));
...
__attribute__((swift_name("ResultDataCallback")))
@protocol SharedResultDataCallback
@required
- (void)resultDataResult:(SharedResultData<SharedGenericResponse<SharedLoanHistory *> *> *)result __attribute__((swift_name("resultData(result:)")));
@end

__attribute__((swift_name("ResultDataInterface")))
@protocol SharedResultDataInterface
@required
- (void)failureMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("failure(message:throwable:)")));
- (void)loadingState:(SharedBoolean * _Nullable)state __attribute__((swift_name("loading(state:)")));
- (void)successResult:(id _Nullable)result code:(SharedInt * _Nullable)code __attribute__((swift_name("success(result:code:)")));
@end
...
@property (readonly) NSString *URL_DEV_INTERNAL_API __attribute__((swift_name("URL_DEV_INTERNAL_API")));
@property (readonly) NSString *URL_DEV_TNK_API __attribute__((swift_name("URL_DEV_TNK_API")));
@property (readonly) NSString *URL_LIVE_INTERNAL_API __attribute__((swift_name("URL_LIVE_INTERNAL_API")));
@property (readonly) NSString *URL_LIVE_TNK_API __attribute__((swift_name("URL_LIVE_TNK_API")));
@property (readonly) NSString *URL_STAGING_INTERNAL_API __attribute__((swift_name("URL_STAGING_INTERNAL_API")));
@property (readonly) NSString *URL_STAGING_TNK_API __attribute__((swift_name("URL_STAGING_TNK_API")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoanHistoryModuleKt")))
@interface SharedLoanHistoryModuleKt : SharedBase
@property (class, readonly) SharedKodein_diDIModule *loanHistoryModule __attribute__((swift_name("loanHistoryModule")));
@end
...
- (void (^)(id<SharedKodein_diDIBuilder>))component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
@required
@property (readonly) id<SharedKodein_typeTypeToken> contextType __attribute__((swift_name("contextType")));
...
- (id<SharedKodein_diDIBuilderTypeBinder>)BindType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag overrides:(SharedBoolean * _Nullable)overrides __attribute__((swift_name("Bind(type:tag:overrides:)")));
...
- (SharedKodein_diDIBuilderDelegateBinder<id> *)DelegateType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag overrides:(SharedBoolean * _Nullable)overrides __attribute__((swift_name("Delegate(type:tag:overrides:)")));
...
@required
- (void)fromBinding:(id<SharedKodein_diDIBinding>)binding __attribute__((swift_name("from(binding:)"))) __attribute__((unavailable("'bind() fron [BINDING]' might be replace by 'bind { [BINDING] }' (This will be remove in Kodein-DI 8.0)")));
@end
...
@property (readonly) id<SharedKodein_typeTypeToken> argType __attribute__((swift_name("argType")));
@property (readonly) id<SharedKodein_typeTypeToken> contextType __attribute__((swift_name("contextType")));
@property (readonly) id<SharedKodein_diDIBindingCopier> _Nullable copier __attribute__((swift_name("copier")));
@property (readonly) id<SharedKodein_typeTypeToken> createdType __attribute__((swift_name("createdType")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
...
@protocol SharedKodein_typeTypeToken
@required
- (SharedKotlinArray<id<SharedKodein_typeTypeToken>> *)getGenericParameters __attribute__((swift_name("getGenericParameters()")));
- (id<SharedKodein_typeTypeToken>)getRaw __attribute__((swift_name("getRaw()")));
- (NSArray<id<SharedKodein_typeTypeToken>> *)getSuper __attribute__((swift_name("getSuper()")));
- (BOOL)isAssignableFromTypeToken:(id<SharedKodein_typeTypeToken>)typeToken __attribute__((swift_name("isAssignableFrom(typeToken:)")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)ToType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("To(type:tag:)")));
...
@property (readonly) id<SharedKodein_typeTypeToken> contextType __attribute__((swift_name("contextType")));
@property (readonly) id<SharedKodein_typeTypeToken> scopeType __attribute__((swift_name("scopeType")));
@end

__attribute__((swift_name("Kodein_diDIBuilderConstantBinder")))
@protocol SharedKodein_diDIBuilderConstantBinder
@required
- (void)WithValueType:(id<SharedKodein_typeTypeToken>)valueType value:(id)value __attribute__((swift_name("With(valueType:value:)")));
@end
...
@required
- (id (^)(id _Nullable))FactoryArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("Factory(argType:type:tag:)")));
- (id (^ _Nullable)(id _Nullable))FactoryOrNullArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("FactoryOrNull(argType:type:tag:)")));
- (id)InstanceType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("Instance(type:tag:)")));
- (id)InstanceArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag arg:(id _Nullable)arg __attribute__((swift_name("Instance(argType:type:tag:arg:)")));
- (id _Nullable)InstanceOrNullType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("InstanceOrNull(type:tag:)")));
- (id _Nullable)InstanceOrNullArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag arg:(id _Nullable)arg __attribute__((swift_name("InstanceOrNull(argType:type:tag:arg:)")));
- (id<SharedKodein_diDirectDI>)OnContext:(id<SharedKodein_diDIContext>)context __attribute__((swift_name("On(context:)")));
- (id (^)(void))ProviderType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("Provider(type:tag:)")));
- (id (^)(void))ProviderArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag arg:(id _Nullable (^)(void))arg __attribute__((swift_name("Provider(argType:type:tag:arg:)")));
- (id (^ _Nullable)(void))ProviderOrNullType:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("ProviderOrNull(type:tag:)")));
- (id (^ _Nullable)(void))ProviderOrNullArgType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag arg:(id _Nullable (^)(void))arg __attribute__((swift_name("ProviderOrNull(argType:type:tag:arg:)")));
...
- (instancetype)initWithContextType:(id<SharedKodein_typeTypeToken>)contextType argType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("init(contextType:argType:type:tag:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKodein_typeTypeToken>)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<SharedKodein_typeTypeToken>)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<SharedKodein_typeTypeToken>)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (id _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedKodein_diDIKey<C, A, T> *)doCopyContextType:(id<SharedKodein_typeTypeToken>)contextType argType:(id<SharedKodein_typeTypeToken>)argType type:(id<SharedKodein_typeTypeToken>)type tag:(id _Nullable)tag __attribute__((swift_name("doCopy(contextType:argType:type:tag:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedKodein_typeTypeToken> argType __attribute__((swift_name("argType")));
...
@property (readonly) id<SharedKodein_typeTypeToken> type __attribute__((swift_name("type")));
@end
...
- (instancetype)initWithContextType:(id<SharedKodein_typeTypeToken> _Nullable)contextType argType:(id<SharedKodein_typeTypeToken> _Nullable)argType type:(id<SharedKodein_typeTypeToken> _Nullable)type tag:(id _Nullable)tag __attribute__((swift_name("init(contextType:argType:type:tag:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
@property id<SharedKodein_typeTypeToken> _Nullable argType __attribute__((swift_name("argType")));
@property id<SharedKodein_typeTypeToken> _Nullable contextType __attribute__((swift_name("contextType")));
@property id _Nullable tag __attribute__((swift_name("tag")));
@property id<SharedKodein_typeTypeToken> _Nullable type __attribute__((swift_name("type")));
@end
